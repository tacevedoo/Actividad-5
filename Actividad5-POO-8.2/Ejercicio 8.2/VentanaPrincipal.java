...
public class VentanaPrincipal extends JFrame implements ActionListener{
    ...
    public void actionPerformed(ActionEvent evento) {
        if(evento.getSource() == calcular) {
            ...
            desviacion.setText("Desviación = " + String.valueOf(String.format("%.2f", notas.CalcularDesviacion())));
            mayor.setText("Mayor = " + String.valueOf(String.format("%.2f", notas.CalcularMayor())));
            menor.setText("Menor = " + String.valueOf(String.format("%.2f", notas.CalcularMenor())));
        }
